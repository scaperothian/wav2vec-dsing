...
if __name__ == "__main__":
    ...
    dataset_folder = os.getcwd()+"/../sing_300x30x2/dataset"


    if split=='TEST':
        # getting things ready for the test split
        utt_folder = dataset_folder + "/test/"
        utt_labels_file  = dataset_folder + "/test_text"
    elif split=='DEV':
        # getting things ready for the test split
        utt_folder = dataset_folder + "/dev/"
        utt_labels_file  = dataset_folder + "/dev_text"
    elif split=='TRAIN1':
        # getting things ready for the test split
        utt_folder = dataset_folder + "/train1/"
        utt_labels_file  = dataset_folder + "/train1_text"    
    else:
